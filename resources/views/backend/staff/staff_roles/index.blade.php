...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col-md-6">
			<h5 class="h4">{{translate('All Roles')}}</h5>
		</div>
        ...
        <table class="table aiz-table">
            <thead>
                <tr>
                    ...
                    <th class="text-center" width="">{{translate('Options')}}</th>
                </tr>
            </thead>
            <tbody>
                @foreach($roles as $key => $role)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('roles.edit', ['id'=>$role->id] )}}" title="{{ translate('Edit') }}">
