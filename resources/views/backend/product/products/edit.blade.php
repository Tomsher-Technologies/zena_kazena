                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-3 col-from-label">{{ translate('Product SKU') }} </label>
                                <div class="col-lg-8">
                                    <input disabled type="text" class="form-control" name="sku"
                            ...
                            <div class="form-group row" id="category">
                                ...
                                <div class="col-lg-8">
                                    <select disabled class="form-control aiz-selectpicker" name="category_id"
                                        id="category_id" data-selected="{{ $product->category_id }}"
                            ...
                            <div class="form-group row" id="brand">
                                ...
                                <div class="col-lg-8">
                                    <select disabled class="form-control aiz-selectpicker" name="brand_id" id="brand_id"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input disabled type="text" class="form-control" name="unit"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input disabled type="number" lang="en" class="form-control" name="min_qty"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input disabled readOnly type="text" class="form-control aiz-tag-input"
                            ...
                            @if (addon_is_activated('pos_system'))
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input disabled type="text" class="form-control" name="barcode"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <label class="aiz-switch aiz-switch-success mb-0" style="margin-top:5px;">
                                            <input disabled type="checkbox" name="refundable"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image"
                                        ...
                                        <input disabled type="hidden" name="photos" value="{{ $product->photos }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div> --}}
                                        <input disabled type="hidden" name="thumbnail_img"
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-6">
                                    <div class="img-upload-preview">
                                        <img loading="lazy"  src="{{ uploaded_asset($photo) }}" alt="" class="img-responsive">
                                            <input disabled type="hidden" name="previous_photos[]" value="{{ $photo }}">
                                ...
                                <div id="thumbnail_img">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                        <div class="img-upload-preview">
                                            ...
                                            <input disabled type="hidden" name="previous_thumbnail_img" value="{{ $product->thumbnail_img }}">
                                            <button type="button" class="btn btn-danger close-btn remove-files"><i class="fa fa-times"></i></button>
                                        </div>
                                    </div>
                                    @endif
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input disabled type="text" class="form-control" name="video_link"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-3">
                                <input disabled type="text" class="form-control" value="{{translate('Colors')}}" disabled>
                            </div>
                            <div class="col-lg-8">
                            ...
                            <div class="col-lg-1">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input disabled value="1" type="checkbox" name="colors_active" <?php if (count(json_decode($product->colors)) > 0) {
                                        echo 'checked';
                                    } ?> >
                                    <span></span>
                                </label>
                            ...
                            <div class="customer_choice_options" id="customer_choice_options">
                                @foreach (json_decode($product->choice_options) as $key => $choice_option)
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                            <input disabled type="hidden" name="choice_no[]"
                                                value="{{ $choice_option->attribute_id }}">
                                            <input disabled type="text" class="form-control" name="choice[]"
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            {{-- <input disabled type="text" class="form-control aiz-tag-input" name="choice_options_{{ $choice_option->attribute_id }}[]" placeholder="{{ translate('Enter choice values') }}" value="{{ implode(',', $choice_option->values) }}" data-on-change="update_sku"> --}}
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input disabled type="text" placeholder="{{ translate('Unit price') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input disabled type="text" class="form-control aiz-date-range"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input disabled type="number" lang="en" min="0" step="0.01"
                                        placeholder="{{ translate('Discount') }}" name="discount" class="form-control"
                                        value="{{ $product->discount }}" required>
                                </div>
                                <div class="col-lg-3">
                                    <select disabled class="form-control aiz-selectpicker" name="discount_type" required>
                            ...
                            @if (addon_is_activated('club_point'))
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input disabled type="number" lang="en" min="0"
                            ...
                            <div id="show-hide-div">
                                <div class="form-group row" id="quantity">
                                    ...
                                    <div class="col-lg-6">
                                        <input disabled type="number" lang="en"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input disabled type="text" placeholder="{{ translate('SKU') }}"
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input disabled type="text" placeholder="{{ translate('External link') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group" data-toggle="aizuploader">
                                        ...
                                        <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                        <input disabled type="hidden" name="pdf" value="{{ $product->pdf }}"
                                            class="selected-files">
                                    </div>
                                    <div class="file-preview box sm">
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" name="og_title"
                                        value="{{ $seo->og_title ?? '' }}" placeholder="{{ translate('OG Title') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="card-body collapse show" id="collapse_2">
                            @if (get_setting('shipping_type') == 'product_wise_shipping')
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input disabled type="radio" name="shipping_type" value="free"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input disabled type="radio" name="shipping_type" value="flat_rate"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input disabled type="checkbox" name="is_quantity_multiplied" value="1"
                    ...
                    {{-- <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="number" name="low_stock_quantity"
                    ...
                    {{-- <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input disabled type="radio" name="stock_visibility_state" value="quantity"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input disabled type="radio" name="stock_visibility_state" value="text"
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="aiz-switch aiz-switch-success mb-0">
                                                    <input disabled type="checkbox" name="cash_on_delivery"
                    ...
                    {{-- <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input disabled type="number" name="flash_discount" value="{{ $product->discount }}"
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    <input disabled type="number" class="form-control" name="est_shipping_days"
                    ...
                    {{-- <div class="card">
                        ...
                        <div class="card-body">
                            @foreach (\App\Models\Tax::where('tax_status', 1)->get() as $tax)
                                <label for="name">
                                    {{ $tax->name }}
                                    <input disabled type="hidden" value="{{ $tax->id }}" name="tax_id[]">
                                </label>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#customer_choice_options').append('\
                                <div class="form-group row">\
                                    <div class="col-md-3">\
                                        <input disabled type="hidden" name="choice_no[]" value="' + i + '">\
                                        <input disabled type="text" class="form-control" name="choice[]" value="' + name +
