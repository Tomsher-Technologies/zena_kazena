...
class ReportController extends Controller
{
    function __construct()
    {
        ...
        $this->middleware('permission:view_reports', ['only' => ['stock_report','in_house_sale_report','seller_sale_report','wish_report','user_search_report','commission_history','wallet_transaction_history']]);
    }
