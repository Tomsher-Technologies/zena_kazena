...
class AttributeController extends Controller
{
    function __construct()
    {
        ...
        $this->middleware('permission:manage_attributes', ['only' => ['index','create','store','show','edit','update','destroy','store_attribute_value','edit_attribute_value','update_attribute_value']]);
    }
